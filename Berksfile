...
cookbook 'conda', github: "hopshadoop/conda-chef", branch: "vdcurrent"
cookbook 'hops', github: "hopshadoop/hops-hadoop-chef", branch: "vdcurrent"
cookbook 'hadoop_spark', github: "hopshadoop/spark-chef", branch: "vdcurrent"
